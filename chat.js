const responses = {
    ...
    "default": "I'm sorry, I didn't understand that. Do you want help?",
    "expert": "Great! would you like to be connected with an expert.",
...
function appendMessage(sender, message) {
    ...
    if(sender === 'bot' && message === responses["expert"]){
        const buttonYes = document.createElement('button');
        buttonYes.textContent = '✔ Yes';
        buttonYes.onclick = function() {
